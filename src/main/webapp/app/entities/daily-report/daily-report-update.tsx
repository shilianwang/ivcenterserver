            ...
            {loading ? (
              ...
              <AvForm model={isNew ? {} : dailyReportEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  ...
                  <AvField id="daily-report-reportDate" type="string" className="form-control" name="reportDate" />
                </AvGroup>
                <AvGroup>
                  <Label id="startTimeLabel" for="startTime">
                    <Translate contentKey="ivcenterserverApp.dailyReport.startTime">Start Time</Translate>
                  </Label>
                  <AvField id="daily-report-startTime" type="string" className="form-control" name="startTime" />
                </AvGroup>
                <AvGroup>
                  <Label id="endTimeLabel" for="endTime">
                    <Translate contentKey="ivcenterserverApp.dailyReport.endTime">End Time</Translate>
                  </Label>
                  <AvField id="daily-report-endTime" type="string" className="form-control" name="endTime" />
                </AvGroup>
                <AvGroup>
