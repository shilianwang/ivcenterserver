  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="ivcenterserverApp.department.delete.question">
          <Translate contentKey="ivcenterserverApp.department.delete.question" interpolate={{ id: departmentEntity.id }}>
