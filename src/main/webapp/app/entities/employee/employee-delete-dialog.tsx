  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="ivcenterserverApp.employee.delete.question">
          <Translate contentKey="ivcenterserverApp.employee.delete.question" interpolate={{ id: employeeEntity.id }}>
