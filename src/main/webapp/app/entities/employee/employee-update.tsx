    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="ivcenterserverApp.employee.home.createOrEditLabel">
              <Translate contentKey="ivcenterserverApp.employee.home.createOrEditLabel">Create or edit a Employee</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
              ...
              <AvForm model={isNew ? {} : employeeEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="firstNameLabel" for="firstName">
                    <Translate contentKey="ivcenterserverApp.employee.firstName">First Name</Translate>
                  </Label>
                  <AvField id="employee-firstName" type="text" name="firstName" />
                  <UncontrolledTooltip target="firstNameLabel">
                    <Translate contentKey="ivcenterserverApp.employee.help.firstName" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="lastNameLabel" for="lastName">
                    <Translate contentKey="ivcenterserverApp.employee.lastName">Last Name</Translate>
                  </Label>
                  <AvField id="employee-lastName" type="text" name="lastName" />
                </AvGroup>
                <AvGroup>
                  <Label id="emailLabel" for="email">
                    <Translate contentKey="ivcenterserverApp.employee.email">Email</Translate>
                  </Label>
                  <AvField id="employee-email" type="text" name="email" />
                </AvGroup>
                <AvGroup>
                  <Label id="phoneNumberLabel" for="phoneNumber">
                    <Translate contentKey="ivcenterserverApp.employee.phoneNumber">Phone Number</Translate>
                  </Label>
                  <AvField id="employee-phoneNumber" type="text" name="phoneNumber" />
                </AvGroup>
                <AvGroup>
                  <Label id="hireDateLabel" for="hireDate">
                    <Translate contentKey="ivcenterserverApp.employee.hireDate">Hire Date</Translate>
                  </Label>
                  <AvInput
                ...
                <AvGroup>
                  <Label id="salaryLabel" for="salary">
                    <Translate contentKey="ivcenterserverApp.employee.salary">Salary</Translate>
                  </Label>
                ...
                <AvGroup>
                  <Label for="department.id">
                    <Translate contentKey="ivcenterserverApp.employee.department">Department</Translate>
                  </Label>
                ...
                <AvGroup>
                  <Label for="manager.id">
                    <Translate contentKey="ivcenterserverApp.employee.manager">Manager</Translate>
                  </Label>
