  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="ivcenterserverApp.jobHistory.delete.question">
          <Translate contentKey="ivcenterserverApp.jobHistory.delete.question" interpolate={{ id: jobHistoryEntity.id }}>
