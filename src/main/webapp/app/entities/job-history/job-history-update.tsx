    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="ivcenterserverApp.jobHistory.home.createOrEditLabel">
              <Translate contentKey="ivcenterserverApp.jobHistory.home.createOrEditLabel">Create or edit a JobHistory</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
              ...
              <AvForm model={isNew ? {} : jobHistoryEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="startDateLabel" for="startDate">
                    <Translate contentKey="ivcenterserverApp.jobHistory.startDate">Start Date</Translate>
                  </Label>
                  <AvInput
                ...
                <AvGroup>
                  <Label id="endDateLabel" for="endDate">
                    <Translate contentKey="ivcenterserverApp.jobHistory.endDate">End Date</Translate>
                  </Label>
                  <AvInput
                ...
                <AvGroup>
                  <Label id="languageLabel">
                    <Translate contentKey="ivcenterserverApp.jobHistory.language">Language</Translate>
                  </Label>
                  <AvInput
                  ...
                  >
                    <option value="FRENCH">
                      <Translate contentKey="ivcenterserverApp.Language.FRENCH" />
                    </option>
                    <option value="ENGLISH">
                      <Translate contentKey="ivcenterserverApp.Language.ENGLISH" />
                    </option>
                    <option value="SPANISH">
                      <Translate contentKey="ivcenterserverApp.Language.SPANISH" />
                    </option>
                  </AvInput>
                </AvGroup>
                <AvGroup>
                  <Label for="job.id">
                    <Translate contentKey="ivcenterserverApp.jobHistory.job">Job</Translate>
                  </Label>
                ...
                <AvGroup>
                  <Label for="department.id">
                    <Translate contentKey="ivcenterserverApp.jobHistory.department">Department</Translate>
                  </Label>
                ...
                <AvGroup>
                  <Label for="employee.id">
                    <Translate contentKey="ivcenterserverApp.jobHistory.employee">Employee</Translate>
                  </Label>
