    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="ivcenterserverApp.job.home.createOrEditLabel">
              <Translate contentKey="ivcenterserverApp.job.home.createOrEditLabel">Create or edit a Job</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
              ...
              <AvForm model={isNew ? {} : jobEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="jobTitleLabel" for="jobTitle">
                    <Translate contentKey="ivcenterserverApp.job.jobTitle">Job Title</Translate>
                  </Label>
                  <AvField id="job-jobTitle" type="text" name="jobTitle" />
                </AvGroup>
                <AvGroup>
                  <Label id="minSalaryLabel" for="minSalary">
                    <Translate contentKey="ivcenterserverApp.job.minSalary">Min Salary</Translate>
                  </Label>
                  <AvField id="job-minSalary" type="string" className="form-control" name="minSalary" />
                </AvGroup>
                <AvGroup>
                  <Label id="maxSalaryLabel" for="maxSalary">
                    <Translate contentKey="ivcenterserverApp.job.maxSalary">Max Salary</Translate>
                  </Label>
                  <AvField id="job-maxSalary" type="string" className="form-control" name="maxSalary" />
                </AvGroup>
                <AvGroup>
                  <Label for="employee.id">
                    <Translate contentKey="ivcenterserverApp.job.employee">Employee</Translate>
                  </Label>
                ...
                <AvGroup>
                  <Label for="tasks">
                    <Translate contentKey="ivcenterserverApp.job.task">Task</Translate>
                  </Label>
                  <AvInput
                    id="job-task"
                    type="select"
