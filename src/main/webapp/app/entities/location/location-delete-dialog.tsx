  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="ivcenterserverApp.location.delete.question">
          <Translate contentKey="ivcenterserverApp.location.delete.question" interpolate={{ id: locationEntity.id }}>
